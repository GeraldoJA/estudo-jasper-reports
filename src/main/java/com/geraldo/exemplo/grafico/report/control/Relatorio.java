package com.geraldo.exemplo.grafico.report.control;
...
public class Relatorio {
	...
	public void gerarRelatorio( List<AbastecimentoDTO> lista, HashMap<String,Object> params) throws JRException {
		...
		InputStream fonte = Relatorio.class.getResourceAsStream("/com/geraldo/exemplo/grafico/report/ireport/relatorio.jrxml");  //carregar o arquivo
